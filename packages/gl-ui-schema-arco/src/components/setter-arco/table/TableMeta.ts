export default {
  ...
  properties: [
    ...
    },
    {
        ...
        },
        {
          ...
          setterComponentProps: {
            options: [
              ...
              { label: '所有页面', value: 'ALL_PAGE'}
            ]
          },
          setterComponentVModelName: 'modelValue',
          description: '导出的数据范围，导出当前页面，导出符合当前查询条件的所有页',
          title: '数据范围',
          setterComponentName: 'ASelect'
        },
        {
          ...
          setterComponentProps: {},
          setterComponentVModelName: 'modelValue',
          description: '可以导出的最大记录数量，限制数量，减少对系统的压力，一般需要控制在5千条以内',
          title: '最大记录数',
          setterComponentName: 'AInputNumber',
          setterDefaultValue: 2000
        },
        {
          name: 'ignoreColumns',
          group: 'base',
          ...
          expanded: true,
          displayMode: 'tile',
          setterComponentProps: {multiple:true,ignoreFields:[""]},
          setterComponentVModelName: 'modelValue',
          description: '在当前列表中，不需要导出的列名（dataIndex）',
          title: '不导出的列',
          setterComponentName: 'GlFieldSelect'
        },
        {
      ...
      title: '导出',
      titleField: 'btnText',
      alarmIfNoSubTitle: '无按钮标题',
      description:"快速配置基于当前页面查询条件、数据列的导出功能，其中导出的数据格式可以在数据列中配置，如数据的计算取值、数据的格式。更灵活的导出功能，可以在工作栏或操作栏上添加按钮，通过脚本编排的方式，结合可自定义的导出模板进行配置。"
    },
    {
      name: 'extra',
      group: 'base',
