...
import IconfontSelect from './setter-arco/icon/IconSelectMeta'
...
import {
  commonActions,
  commonPropsDataEntry,
  commonPropsOther,
  commonMethods
} from './setter-arco/CommonProperties'
...
import PageTemplateSimpleApproveMeta from './setter-arco/page-template/PageTemplateStateWFMeta'
import PageTemplateSimpleApproveInstance from './setter-arco/page-template/PageTemplateStateWFInstance'
...
const customInstances: Array<ComponentInstance> = [
  ...
  HiddenAreaInstance,
  FormInstance,
  RowColLayoutInstance,
  RadioGroupInstance,
  CheckboxGroupGroupInstance,
  CascaderInstance,
  LayoutPageInstance,
  TemplateInstance,
  LoopInstance,
...
for (const index in componentMetas) {
  ...
  meta.methods.push(...commonMethods)
