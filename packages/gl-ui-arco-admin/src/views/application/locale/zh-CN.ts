export default {
  ...
  'application.app.list.purpose': '应用范围',
  'application.app.list.purpose.inside': '企业内部',
  'application.app.list.purpose.outside': '企业外部',
  'application.app.list.purpose.side': '企业内外部',
  'application.app.list.purpose.extra': '用于区分控制，该应用只面向企业内部人员，还是可同时面向企业外部人员。',
