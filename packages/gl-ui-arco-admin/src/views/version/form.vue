...
// 引入组件
import AppVersionModel from './model.vue';
...
const tableFormRef = shallowRef(AppVersionModel);
...
<template>
  <a-modal draggable  v-if="isModal"
           ...
           :title="title || $t(`security.org.index.model.title.${formState}`)"
           :width="width || ''" title-align="start"
           @cancel="handleModelCancel($event)" @before-ok="handleModelOk">
    <AppVersionModel ref="tableFormRef"
