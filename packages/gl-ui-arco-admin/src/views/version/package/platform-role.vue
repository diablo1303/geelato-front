...
import type {PageQueryFilter, QueryRoleForm, QueryRoleTreeNodeForm, QueryTreeNodeForm} from '@geelato/gl-ui';
import {treeNodeTypeOptions} from "../../compare/type";
            ...
            <a-table :bordered="{cell:true}"
              ...
              <template #columns>
                ...
                <a-table-column :ellipsis="true" :tooltip="true" :width="120" data-index="type" title="类型">
                  <template #cell="{ record }">
                    {{ utils.getOptionLabel(record.type, treeNodeTypeOptions) }}
                  </template>
                </a-table-column>
