...
import type {PageQueryFilter, PageQueryRequest, QueryDictItemForm, QueryDictForm} from '@geelato/gl-ui';
// 页面所需 对象、方法
...
const fetchData = async (params: PageQueryRequest) => {
  ...
  try {
    ...
    renderData.value = setTree(data.items as unknown as QueryDictItemForm[]) as unknown as PageQueryFilter[];
        ...
        <a-row :gutter="wrapperCol">
          <a-col :span="(labelCol+wrapperCol)/filterCol">
            <a-form-item :label="$t('security.dictItem.index.form.itemName')" field="name">
              <a-input v-model="filterData.itemName" allow-clear @clear="condition" @press-enter="condition"/>
            </a-form-item>
          </a-col>
          <a-col :span="(labelCol+wrapperCol)/filterCol">
            <a-form-item :label="$t('security.dictItem.index.form.itemCode')" field="code">
              <a-input v-model="filterData.itemCode" allow-clear @clear="condition" @press-enter="condition"/>
            </a-form-item>
          </a-col>
          <a-col :span="(labelCol+wrapperCol)/filterCol">
