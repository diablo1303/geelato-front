...
// 引入组件
import SystemConfigModel from './model.vue';
...
const tableFormRef = shallowRef(SystemConfigModel);
...
<template>
  <a-modal draggable  v-if="isModal"
           ...
           :title="title || $t(`security.sysConfig.index.model.title.${formState}`)"
           :width="width || ''" title-align="start"
           @cancel="handleModelCancel($event)" @before-ok="handleModelOk">
    <SystemConfigModel ref="tableFormRef"
