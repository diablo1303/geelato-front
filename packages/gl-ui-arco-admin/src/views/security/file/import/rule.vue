...
import {utils, dictApi, modelApi} from "@geelato/gl-ui";
import type {QueryDictForm, QueryTableColumnForm, QueryTableForm, PageQueryRequest} from "@geelato/gl-ui";
import {type BusinessRuleData, type BusinessTypeData, businessRuleDataTypeOptions} from "./template";
...
const generateFormData = (): BusinessRuleData => {
  return {
    ...
    priority: false,
    retain: false,
    order: Number(utils.generateRandom(6)),
    remark: '',
    columnNameArr: [],
    ruleTableName: '',
    ruleColumnName: [],
