...
import type {PageQueryFilter, PageQueryRequest, QueryRoleUserForm, QueryRoleForm} from '@geelato/gl-ui';
// 页面所需 对象、方法
import useLoading from '../../../../hooks/loading';
import {type Pagination, PageSizeOptions} from '../../../../types/global';
import {enableStatusOptions, typeOptions} from "../../role/searchTable";
import UserSelectRoleForm from "./form.vue";
 ...
 * @param data
 */
const deleteTable = (data: QueryRoleUserForm) => {
        ...
        <a-row :gutter="wrapperCol">
          <a-col :span="(labelCol+wrapperCol)/filterCol">
            <a-form-item :label="$t('security.role.index.form.name')" field="roleName">
              <a-input v-model="filterData.roleName" allow-clear @clear="condition" @press-enter="condition"/>
            </a-form-item>
          </a-col>
          <a-col :span="(labelCol+wrapperCol)/filterCol">
            <a-form-item :label="$t('security.role.index.form.code')" field="roleCode">
              <a-input v-model="filterData.roleCode" allow-clear @clear="condition" @press-enter="condition"/>
            </a-form-item>
          </a-col>
          <a-col :span="(labelCol+wrapperCol)/filterCol">
            <a-form-item :label="$t('security.role.index.form.weight')" field="roleWeight">
              <a-input v-model="filterData.roleWeight" allow-clear @clear="condition" @press-enter="condition"/>
            </a-form-item>
          </a-col>
          <a-col :span="(labelCol+wrapperCol)/filterCol">
