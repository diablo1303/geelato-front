export default {
  ...
  'security.dict.index.form.creatorName': '创建人员',
  'security.dict.index.form.updateAt': '修改时间',
  'security.dict.index.form.updaterName': '修改人员',
  ...
  'security.role.index.form.usedApp': '用于应用',
  'security.role.index.form.usedApp.1': '是',
  'security.role.index.form.usedApp.0': '否',
  'security.role.index.form.usedApp.extra': '该平台级角色是否可以用于应用。',
  'security.role.index.form.appIds': '关联应用',
  'security.role.index.form.appIds.placeholder': '选择需要用到该角色的应用',
  'security.role.index.form.appIds.extra': '选择需要用到该角色的应用，在选择的应用下进行模型、页面、元素等授权，请谨慎操作。',
  'security.role.index.form.seqNo': '排序',
  'security.role.index.form.createAt': '创建时间',
  'security.role.index.form.creatorName': '创建人员',
  'security.role.index.form.updateAt': '修改时间',
  'security.role.index.form.updaterName': '修改人员',
  ...
  'security.encoding.index.form.creatorName': '创建人员',
  'security.encoding.index.form.updateAt': '修改时间',
  'security.encoding.index.form.updaterName': '修改人员',
  ...
  'security.encoding.index.form.itemType.variable': '变量',
  'security.encoding.index.form.itemType.variable.tenant': '当前租户',
  'security.encoding.index.form.itemType.variable.tenant.id': '主键',
  'security.encoding.index.form.itemType.variable.tenant.code': '编码',
  'security.encoding.index.form.itemType.variable.tenant.name': '名称',
  'security.encoding.index.form.itemType.variable.app': '当前应用',
  'security.encoding.index.form.itemType.variable.app.id': '主键',
  'security.encoding.index.form.itemType.variable.app.code': '编码',
  'security.encoding.index.form.itemType.variable.app.name': '名称',
  'security.encoding.index.form.itemType.variable.app.versionInfo': '版本',
  'security.encoding.index.form.itemType.variable.user': '当前用户',
  'security.encoding.index.form.itemType.variable.user.id': '主键',
  'security.encoding.index.form.itemType.variable.user.name': '名称',
  'security.encoding.index.form.itemType.variable.user.enName': '英文名称',
  'security.encoding.index.form.itemType.variable.user.loginName': '登录名称',
  'security.encoding.index.form.itemType.variable.user.jobNumber': '工号',
  'security.encoding.index.form.itemType.variable.user.orgId': '所属组织主键',
  'security.encoding.index.form.itemType.variable.user.orgName': '所属组织名称',
  'security.encoding.index.form.itemType.variable.user.companyId': '所属公司主键',
  'security.encoding.index.form.itemType.variable.user.companyName': '所属公司名称',
  'security.encoding.index.form.itemType.variable.user.email': '邮箱',
  'security.encoding.index.form.itemType.variable.user.mobilePhone': '手机号码',
  'security.encoding.index.form.itemType.variable.user.cooperatingOrgId': '所属外部组织主键',
  'security.encoding.index.form.itemType.variable.placeholder': '请选择当前租户、应用和用户等系统变量',
  'security.encoding.index.form.itemType.argument': '参数',
  'security.encoding.index.form.itemType.argument.placeholder': '请输入以字母开头，有【a-zA-Z0-9_-】组成的字符串',
  ...
  'security.file.index.form.id': '主键',
  ...
  'security.file.index.form.creatorName': '创建人员',
  'security.file.index.form.updateAt': '修改时间',
  'security.file.index.form.updaterName': '修改人员',
  ...
  'security.sysConfig.index.form.valueType.string': '字符串',
  'security.sysConfig.index.form.valueType.number': '数值',
  'security.sysConfig.index.form.valueType.boolean': '布尔值',
  'security.sysConfig.index.form.valueType.datetime': '日期时间',
  'security.sysConfig.index.form.valueType.json': 'Json',
  'security.sysConfig.index.form.valueType.encrypt': '加密',
  'security.sysConfig.index.form.valueType.base64': '上传(Base64)',
  'security.sysConfig.index.form.valueType.upload': '上传文件',
  'security.sysConfig.index.form.configValue': '配置值',
  'security.sysConfig.index.form.configValue.encrypt.edit': '编辑（解密）',
  'security.sysConfig.index.form.configValue.encrypt.view': '查看（解密）',
  'security.sysConfig.index.form.remark': '备注',
  'security.sysConfig.index.form.appId': '所属应用',
  'security.sysConfig.index.form.purpose': '使用范围',
  'security.sysConfig.index.form.purpose.help': '重要信息请不要使用“前端可见”！',
  'security.sysConfig.index.form.purpose.all': '所有可见',
  'security.sysConfig.index.form.purpose.webapp': '前端可见',
  'security.sysConfig.index.form.purpose.endpoint': '后端可用',
  'security.sysConfig.index.form.purpose.workflow': '工作流可用',
  'security.sysConfig.index.form.purpose.schedule': '调度可用',
  ...
  'security.sysConfig.index.form.encrypted': '加密',
  'security.sysConfig.index.form.encrypted.0': '否',
  'security.sysConfig.index.form.encrypted.1': '是',
  'security.sysConfig.index.form.encrypted.false': '否',
  'security.sysConfig.index.form.encrypted.true': '是',
  'security.sysConfig.index.form.createAt': '创建时间',
  'security.sysConfig.index.form.creatorName': '创建人员',
  'security.sysConfig.index.form.updateAt': '修改时间',
  'security.sysConfig.index.form.updaterName': '修改人员',
