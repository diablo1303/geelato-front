export default {
  ...
  'searchTable.columns.operations.update.msg': 'Whether to update the basic information？',
  // size
  ...
  'security.dict.index.form.seqNo': 'seqNo',
  'security.dict.index.form.dictRemark': 'remark',
  'security.dict.index.form.createAt': 'createTime',
  'security.dict.index.form.creatorName': 'creatorName',
  'security.dict.index.form.updateAt': 'updateTime',
  'security.dict.index.form.updaterName': 'updaterName',
  ...
  'security.dictItem.index.form.seqNo': 'seqNo',
  ...
  'security.dictItem.index.popover.item.title': 'Dictionary Item',
  ...
  'security.permission.index.form.type.dp': 'Data',
  'security.permission.index.form.type.ep': 'Page Element',
  'security.permission.index.form.type.mp': 'Entity Model',
  'security.permission.index.form.type.cp': 'Entity Column',
  'security.permission.index.form.classify.view': 'View Permission（Default）',
  'security.permission.index.form.classify.edit': 'Edit Permission（Default）',
  'security.permission.index.form.classify.custom': 'Custom Permission',
  ...
  'security.role.index.form.weight.reset.tip': 'Reset to default weights',
  ...
  'security.role.index.form.usedApp': 'usedApp',
  'security.role.index.form.usedApp.1': 'YES',
  'security.role.index.form.usedApp.0': 'NO',
  'security.role.index.form.usedApp.extra': 'Whether the platform-level role is available for the application.',
  'security.role.index.form.appIds': 'associatedApps',
  'security.role.index.form.appIds.placeholder': 'Select the application that requires the role',
  'security.role.index.form.appIds.extra': 'Select the application where the role is required and authorize the model, page, and element in the selected application. Exercise caution when performing this operation.',
  'security.role.index.form.seqNo': 'sequence',
  'security.role.index.form.createAt': 'createTime',
  'security.role.index.form.creatorName': 'creatorName',
  'security.role.index.form.updateAt': 'updateTime',
  'security.role.index.form.updaterName': 'updaterName',
  ...
  'security.encoding.index.form.creatorName': 'creatorName',
  'security.encoding.index.form.updateAt': 'updateTime',
  'security.encoding.index.form.updaterName': 'updaterName',
  ...
  'security.encoding.index.form.itemType.variable': 'variable',
  'security.encoding.index.form.itemType.variable.tenant': 'TENANT',
  'security.encoding.index.form.itemType.variable.tenant.id': 'PRIMARY KEY',
  'security.encoding.index.form.itemType.variable.tenant.code': 'CODE',
  'security.encoding.index.form.itemType.variable.tenant.name': 'NAME',
  'security.encoding.index.form.itemType.variable.app': 'APPLICATION',
  'security.encoding.index.form.itemType.variable.app.id': 'PRIMARY KEY',
  'security.encoding.index.form.itemType.variable.app.code': 'CODE',
  'security.encoding.index.form.itemType.variable.app.name': 'NAME',
  'security.encoding.index.form.itemType.variable.app.versionInfo': 'VERSION',
  'security.encoding.index.form.itemType.variable.user': 'USER',
  'security.encoding.index.form.itemType.variable.user.id': 'PRIMARY KEY',
  'security.encoding.index.form.itemType.variable.user.name': 'NAME',
  'security.encoding.index.form.itemType.variable.user.enName': 'ENGLISH NAME',
  'security.encoding.index.form.itemType.variable.user.loginName': 'LOGIN NAME',
  'security.encoding.index.form.itemType.variable.user.jobNumber': 'JOB NUMBER',
  'security.encoding.index.form.itemType.variable.user.orgId': 'ORGANIZATION PRIMARY KEY',
  'security.encoding.index.form.itemType.variable.user.orgName': 'ORGANIZATION NAME',
  'security.encoding.index.form.itemType.variable.user.companyId': 'COMPANY PRIMARY KEY',
  'security.encoding.index.form.itemType.variable.user.companyName': 'COMPANY NAME',
  'security.encoding.index.form.itemType.variable.user.email': 'EMAIL',
  'security.encoding.index.form.itemType.variable.user.mobilePhone': 'MOBILE PHONE',
  'security.encoding.index.form.itemType.variable.user.cooperatingOrgId': 'COOPERATING ORGANIZATION PRIMARY KEY',
  'security.encoding.index.form.itemType.variable.placeholder': 'Select system variables such as the current tenant, application, and user',
  'security.encoding.index.form.itemType.argument': 'argument',
  'security.encoding.index.form.itemType.argument.placeholder': 'Please enter a string that starts with a letter and consists of [a-zA-Z0-9_ -]',
  ...
  'security.file.index.form.id': 'primaryKey',
  ...
  'security.file.index.form.appId': 'application',
  ...
  'security.file.index.form.creatorName': 'creatorName',
  'security.file.index.form.updateAt': 'updateTime',
  'security.file.index.form.updaterName': 'updaterName',
  ...
  'security.file.index.example.import.text': 'Import example',
  ...
  'security.sysConfig.index.form.keyType': 'keyType',
  'security.sysConfig.index.form.valueType': 'valueType',
  'security.sysConfig.index.form.valueType.string': 'String',
  'security.sysConfig.index.form.valueType.number': 'Number',
  'security.sysConfig.index.form.valueType.boolean': 'Boolean',
  'security.sysConfig.index.form.valueType.datetime': 'DateTime',
  'security.sysConfig.index.form.valueType.json': 'Json',
  'security.sysConfig.index.form.valueType.encrypt': 'Encrypt',
  'security.sysConfig.index.form.valueType.base64': 'Base64',
  'security.sysConfig.index.form.valueType.upload': 'Upload',
  'security.sysConfig.index.form.configKey': 'configKey',
  'security.sysConfig.index.form.configValue': 'configValue',
  'security.sysConfig.index.form.configValue.encrypt.edit': 'Edit(Decode)',
  'security.sysConfig.index.form.configValue.encrypt.view': 'View(Decode)',
  'security.sysConfig.index.form.remark': 'remark',
  'security.sysConfig.index.form.appId': 'application',
  'security.sysConfig.index.form.purpose': 'purpose',
  'security.sysConfig.index.form.purpose.help': 'Important information Please do not use "webapp visible"!',
  'security.sysConfig.index.form.purpose.all': 'all visible',
  'security.sysConfig.index.form.purpose.webapp': 'webapp visible',
  'security.sysConfig.index.form.purpose.endpoint': 'endpoint usable',
  'security.sysConfig.index.form.purpose.workflow': 'workflow usable',
  'security.sysConfig.index.form.purpose.schedule': 'schedule usable',
  ...
  'security.sysConfig.index.form.encrypted': 'encrypt',
  'security.sysConfig.index.form.encrypted.0': 'NO',
  'security.sysConfig.index.form.encrypted.1': 'YES',
  'security.sysConfig.index.form.encrypted.false': 'NO',
  'security.sysConfig.index.form.encrypted.true': 'YES',
  'security.sysConfig.index.form.createAt': 'createTime',
  'security.sysConfig.index.form.creatorName': 'creatorName',
  'security.sysConfig.index.form.updateAt': 'updateTime',
  'security.sysConfig.index.form.updaterName': 'updaterName',
