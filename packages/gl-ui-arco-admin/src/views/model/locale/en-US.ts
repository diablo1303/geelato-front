export default {
  ...
  'model.connect.index.model.sync.table.title': 'Create or update model information and model fields in the database.',
  ...
  'model.table.index.form.packBusData.tip.1': 'For deployment, only insert the packaged data without modifying or deleting the target table data; generally, the data requiring parallel maintenance in the production environment, such as the parameters of the system.',
  'model.table.index.form.packBusData.2': 'Full packing',
  'model.table.index.form.packBusData.tip.2': 'For deployment, insert the packaged data after emptying the target table.',
  'model.table.index.form.packBusData.extra': 'Package the business data for insertion time. Incremental insertion (only insert the packaged data, no modification or delete the target table data; generally the data that needs to be maintained in the production environment, such as the parameters of the system.); Full update (insert the packaged data after emptying the target table.）',
  ...
  'model.view.index.model.info.release': 'Release Successfully！That is, the view is created or updated in the database.',
  'model.view.index.model.info.release.tip': 'If you can\'t find this view in the app Design Selection entity, click the button "Refresh Model cache"',
  ...
  "model.column.index.form.extraMap": "extraMap",
  "model.column.index.form.extraMap.0": "One to One",
  "model.column.index.form.extraMap.1": "One to Many",
  "model.column.index.form.extraMap.2": "Many to One",
  "model.column.index.form.extraMap.3": "Many to Many",
  ...
  'model.column.index.form.drawed': 'drawed',
  'model.column.index.form.drawed.tip': 'DrawDB Whether to display the field？',
  'model.column.index.form.drawed.1': 'YES',
  'model.column.index.form.drawed.0': 'NO',
  'model.column.index.form.drawed.true': 'true',
  'model.column.index.form.drawed.false': 'false',
  ...
  'searchTable.columns.operations.refresh.table.title': 'Click this button if the model, field, and view are not included in the selection of entity, entity field, and view when applying the design.',
