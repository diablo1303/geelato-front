...
import type {FormInstance, SelectOptionGroup, TableColumnData} from "@arco-design/web-vue";
import {utils, isUtil, modelApi, applicationApi} from '@geelato/gl-ui'
import type {PageQueryRequest, QueryAppForm, QueryTableColumnForm, QueryTableForm, QueryViewForm} from '@geelato/gl-ui';
 ...
 * @param failBack
 */
const saveData = async (params: QueryViewForm, successBack?: any, failBack?: any) => {
  tabsKey.value = 1;
...
const saveOrUpdate = (successBack?: any, failBack?: any) => {
  saveData(formData.value, (data: QueryViewForm) => {
    // 设计当前页面的操作
    if (successBack && typeof successBack === 'function') successBack(data);
  }, () => {
    if (failBack && typeof failBack === 'function') failBack();
