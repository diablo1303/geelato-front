...
// 引入组件
import ModelTableViewModel from './model.vue';
...
const tableFormRef = shallowRef(ModelTableViewModel);
...
<template>
  <a-modal draggable  v-if="isModal"
           ...
           :title="title || $t(`model.view.index.model.title.${formState}`)"
           :width="width || ''" title-align="start"
           @cancel="handleModelCancel($event)" @before-ok="handleModelOk">
    <ModelTableViewModel ref="tableFormRef"
