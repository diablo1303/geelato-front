...
import type {PageQueryRequest, QueryAppForm, QueryTableForm} from '@geelato/gl-ui';
 ...
 * @param failBack
 */
const saveData = async (params: QueryTableForm, successBack?: any, failBack?: any) => {
...
const saveOrUpdate = (successBack?: any, failBack?: any) => {
  saveData(formData.value, (data: QueryTableForm) => {
    // 设计当前页面的操作
    if (successBack && typeof successBack === 'function') successBack(data);
  }, () => {
