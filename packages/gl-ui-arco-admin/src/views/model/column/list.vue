...
import type {FormInstance, TableColumnData, TableSortable} from '@arco-design/web-vue';
import {utils, modelApi} from '@geelato/gl-ui'
import type {PageQueryFilter, PageQueryRequest, FormParams, QueryAppForm, QueryTableForm, QueryTableColumnForm, ColumnSelectType} from '@geelato/gl-ui';
// 页面所需 对象、方法
 ...
 * @param data
 */
const viewTable = (data: QueryTableColumnForm) => {
  Object.assign(formParams.value, {
...
watch(() => props, async (val) => {
  if (props.visible === true) {
    ...
    // 模型默认字段
    await modelApi.getDefaultColumnNames((data: string[]) => {
