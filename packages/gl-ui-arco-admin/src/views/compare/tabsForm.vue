...
import {versionApi, applicationApi} from '@geelato/gl-ui'
import type {QueryAppVersionForm, QueryAppForm} from '@geelato/gl-ui';
import type {AppMeta, AppVersion, PageParams} from "./type";
import CompareModel from "./model.vue";
import PlatformModelCompare from "./package/platform-model.vue";
import PlatformDictCompare from "./package/platform-dict.vue";
import PlatformPageCompare from "./package/platform-page.vue";
import PlatformSysConfigCompare from "./package/platform-sys-config.vue";
import PlatformExportTemplateCompare from "./package/platform-export-template.vue";
import PlatformEncodingCompare from "./package/platform-encoding.vue";
import PlatformResourcesCompare from "./package/platform-resources.vue";
import PlatformApiCompare from "./package/platform-api.vue";
