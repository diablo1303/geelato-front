...
import {parseJson, directions, queryCompareType, sortRenderData, objValueToArray, getDiffData,} from "../type";
...
const queryRenderData = (list: AppMeta[], data: TreeLevelData) => {
  ...
  // 层级和表对应
  data.level = {
    1: "platform_dev_db_connect", 2: "platform_dev_table", 3: "platform_dev_view",
    4: "platform_dev_column", 5: "platform_dev_table_foreign"
  };
