<template>
  <div className="gl-bpmn-toolbar">
    <span class="gl-btn" title="生成XML" @mousedown="downloadXml">下载 XML</span>
    <span class="gl-btn" id="download-img" title="生成图片" @mousedown="downloadImage"
      >下载图片
    </span>
