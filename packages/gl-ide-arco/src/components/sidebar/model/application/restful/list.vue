...
<template>
  <GlModelRestfulAppForm v-model:visible="formPage.visible"
        ...
        <a-row :gutter="16">
          ...
          <a-col :span="isModal?12:8">
            <a-form-item field="approvalNeed" label="是否审批">
              <a-select v-model="filterData.approvalNeed" :options="approvalNeedOptions" allow-clear
                        placeholder="全部" @change="conditionChange" @clear="condition"/>
            </a-form-item>
          </a-col>
          <a-col :span="isModal?12:8">
            <a-form-item field="approvalStatus" label="审批状态">
              <a-select v-model="filterData.approvalStatus" :options="approvalStatusOptions" allow-clear
                        placeholder="全部" @change="conditionChange" @clear="condition"/>
            </a-form-item>
          </a-col>
        </a-row>
  ...
  <a-table
    ...
    <template #columns>
      ...
      <a-table-column :ellipsis="true" :tooltip="true" :width="150" data-index="appName" title="应用名称"/>
