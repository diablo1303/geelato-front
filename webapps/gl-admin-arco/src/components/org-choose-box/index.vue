...
<template>
  <span v-if="!onlyModal" class="tag-box">
    <span class="box-inner">
      <span v-for="(item,index) of tagData" :key="index" :title="item.name" class="box-data">
        {{ item.name }}
        <icon-close v-if="!props.disabled" :title="$t('orgChooseBox.index.delete')"
                    class="data-close"
    ...
    <span v-if="!props.disabled" class="box-button">
      <a-button :title="$t('orgChooseBox.index.select')"
                class="button-primary" type="dashed"
                @click="editClick($event)">
        <IconEdit/>
      </a-button>
      <a-button :title="$t('orgChooseBox.index.delete')"
  ...
  <a-modal
      ...
      :cancel-text="$t('orgChooseBox.index.modal.cancel')"
      :ok-text="$t('orgChooseBox.index.modal.confirm')"
      :title="$t('orgChooseBox.index.modal.title')"
