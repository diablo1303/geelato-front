export default {
  ...
  'model.table.index.form.packBusData.tip.1': 'For deployment, only insert the packaged data, do not modify or delete the target table data.',
  'model.table.index.form.packBusData.2': 'Full packing',
  'model.table.index.form.packBusData.tip.2': 'For deployment, insert the packaged data after emptying the target table; usually the data that requires parallel maintenance in the production environment, such as the parameters of the system.',
  'model.table.index.form.packBusData.extra': 'Package the business data for insertion time. Incremental insertion (only insert the packaged data, do not modify or delete the target table data.); Full update (insert the packaged data after emptying the target table; generally the data that needs to be maintained in the production environment, such as the parameters of the system.）',
