export default {
  ...
  'model.connect.index.model.sync.table.title': '将模型信息，模型字段在数据库中创建或更新。',
  ...
  'model.table.index.form.packBusData.tip.1': '用于部署时，只插入本次打包的数据，不修改不删除目标表数据；一般为需要在生产环境并行维护的数据，如系统的参数。',
  'model.table.index.form.packBusData.2': '全量打包',
  'model.table.index.form.packBusData.tip.2': '用于部署时，清空目标表之后插入本次打包的数据。',
  'model.table.index.form.packBusData.extra': '打包业务数据，用于插入时。增量插入（只插入本次打包的数据，不修改不删除目标表数据；一般为需要在生产环境并行维护的数据，如系统的参数。）；全量更新（清空目标表之后插入本次打包的数据。）',
  ...
  'searchTable.columns.operations.releaseMsg': '是否发布该条视图? 即将该视图在数据库中创建或更新。',
  'model.view.index.model.info.reset': '重置成功！',
  'model.view.index.model.info.release': '发布成功！',
  'model.view.index.model.info.release.tip': '若在应用设计选择实体中查询不到该视图，请点击按钮“刷新模型缓存”',
  ...
  "model.column.index.form.extraMap": "映射关系",
  "model.column.index.form.extraMap.0": "一对一",
  "model.column.index.form.extraMap.1": "一对多",
  "model.column.index.form.extraMap.2": "多对一",
  "model.column.index.form.extraMap.3": "多对多",
  ...
  'model.column.index.form.drawed': '是否展示',
  'model.column.index.form.drawed.tip': 'DrawDB 是否展示该字段',
  'model.column.index.form.drawed.1': '是',
  'model.column.index.form.drawed.0': '否',
  'model.column.index.form.drawed.true': '是',
  'model.column.index.form.drawed.false': '否',
  ...
  'searchTable.columns.operations.refresh.table.title': '若应用设计时，在选择实体、实体字段和视图没有该模型、字段和视图，可点击此按钮。',
