<template>
  <a-modal v-model:visible="visible" width="360px" title="更改电子邮箱" title-align="start" @cancel="cancelModalClick($event)">
...
const formatValidData = (): AuthCodeForm => {
  return {
    action: 'updateEmail', validType: '2', prefix: '+86', validBox: '', userId: '1', authCode: ''
  };
}
