export default {
  ...
  'application.app.list.applyStatus': '应用站点状态',
  'application.app.list.designStatus': '设计站点状态',
  ...
  'application.app.list.operations.enter.manage': '管理站点',
  'application.app.list.operations.enter.design': '设计站点',
  'application.app.list.operations.enter.index': '应用站点',
