export default {
  ...
  'security.sysConfig.index.form.purpose.webapp': '前端',
  'security.sysConfig.index.form.purpose.endpoint': '后端',
  'security.sysConfig.index.form.purpose.workflow': '工作流',
  'security.sysConfig.index.form.purpose.schedule': '调度',
