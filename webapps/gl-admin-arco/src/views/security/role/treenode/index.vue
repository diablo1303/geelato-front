<template>
  <div class="container">
    <Breadcrumb :items="['security.roleTreeNode.index.menu.list', 'security.roleTreeNode.index.menu.list.searchTable']"/>
    <a-card :title="$t('security.roleTreeNode.index.menu.list.searchTable')" class="general-card">
      <!-- list   -->
