...
// 引入组件
import EncodingList from "./list.vue";
...
<template>
  <div class="container">
    <Breadcrumb :items="['security.encoding.index.menu.list', 'security.encoding.index.menu.list.searchTable']"/>
    <a-card class="general-card">
      <EncodingList :filterCol="listParams.filterCol"
