<template v-model="pageData">
          ...
          <template #content>
            <div id="tableSetting">
              <div v-for="(item, index) in showColumns" :key="item.dataIndex" class="setting">
                ...
                <div class="title">
                  {{ item.title === '#' ? $t('security.encoding.index.form.index') : $t(`${item.title}`) }}
                </div>
              </div>
            </div>
          </template>
  ...
  <a-table
    ...
    <template #columns>
      <a-table-column :title="$t('security.encoding.index.form.index')" :width="80" align="center" data-index="index">
      ...
      <a-table-column :title="$t('security.encoding.index.form.createAt')" :width="180" data-index="createAt"></a-table-column>
      <a-table-column
          :title="$t('security.encoding.index.form.operations')" :width="pageData.formState==='edit'?230:100" align="center" data-index="operations"
          fixed="right">
        <template #cell="{ record }">
...
import {deleteEncoding as deleteList, FilterEncodingForm as FilterForm, pageQueryEncoding as pageQueryList} from '@/api/encoding';
