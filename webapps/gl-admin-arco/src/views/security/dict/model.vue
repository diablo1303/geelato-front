<template v-model="pageData">
  <a-form ref="validateForm" :label-col-props="{ span: 6 }" :model="formData" :wrapper-col-props="{ span: 18 }" class="form">
    ...
    <a-form-item
        :label="$t('sercurity.dict.index.form.dicName')"
    ...
    <a-form-item
        :label="$t('sercurity.dict.index.form.dicCode')"
        :rules="[{required: true,message: $t('sercurity.form.rules.match.required')}]"
        field="dicCode">
    ...
    <a-form-item
        :label="$t('sercurity.dict.index.form.tenantCode')"
        :rules="[{required: true,message: $t('sercurity.form.rules.match.required')}]"
        field="tenantCode">
    ...
    <a-form-item
        :label="$t('sercurity.dict.index.form.enableStatus')"
        :rules="[{required: true,message: $t('sercurity.form.rules.match.required')}]"
        field="enableStatus">
      ...
      <span v-else>{{ $t(`sercurity.dict.index.form.enableStatus.${formData.enableStatus}`) }}</span>
    </a-form-item>
    <a-form-item
    ...
    <a-form-item :label="$t('sercurity.dict.index.form.dicRemark')" field="dicRemark">
