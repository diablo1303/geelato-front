...
<template>
  <div class="container">
    <GlBreadcrumb :items="['security.dictItem.index.menu.list', 'security.dictItem.index.menu.list.searchTable']"/>
    <a-card class="general-card">
      <GlDictionaryEntryList :filterCol="listParams.filterCol"
