 ...
 * @param params
 */
const getUrlParams = function (params: Record<string, any>) {
  const parameters = []
...
export {toCamelCase, formatSeparator, buildUrl, copyToClipboard, generateRandom, formatTime, getUrlParams};